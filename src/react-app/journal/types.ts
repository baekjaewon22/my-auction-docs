...
export const BID_PROPERTY_CATEGORIES = [
  {
    main: '주거시설',
    details: ['아파트', '주택', '다세대(빌라)', '다가구주택', '근린주택', '오피스텔', '도시형생활주택', '콘도(호텔)', '펜션(캠핑장)', '숙박시설'],
  },
  {
    main: '상업·업무시설',
    details: ['근린시설', '근린상가', '상가', '아파트상가', '사무실', '운동시설', '휴게시설', '목욕시설', '주유소'],
  },
  {
    main: '산업·생산시설',
    details: ['공장', '아파트형공장', '창고', '축사(농가시설)'],
  },
  {
    main: '토지',
    details: ['대지', '임야', '전', '답', '과수원', '잡종지', '공장용지', '도로', '목장용지', '창고용지', '유지', '하천', '구거', '기타토지'],
  },
  {
    main: '특수·공공·기타 시설',
    details: ['병원', '교육시설', '학교', '노유자시설', '장례관련시설', '자동차관련시설', '주차장', '묘지', '종교시설', '양어장', '기타'],
  },
  {
    main: '권리·동산류',
    details: ['광업권', '어업권', '선박', '차량', '중장비'],
  },
] as const;
...
const COURT_DATA: { main: string; branches: string[] }[] = [
  ...
  { main: '대구지방법원', branches: ['서부지원', '안동지원', '경주지원', '김천지원', '상주지원', '의성지원', '영덕지원', '포항지원'] },
  { main: '부산지방법원', branches: ['동부지원', '서부지원'] },
