...
const ROLE_COLORS: Record<Role, string> = {
  master: '#7b1fa2', ceo: '#1a73e8', cc_ref: '#1a73e8', admin: '#e65100', director: '#0d47a1', accountant: '#283593', accountant_asst: '#00695c', manager: '#188038', member: '#5f6368', support: '#3949ab', resigned: '#bdc1c6',
};
