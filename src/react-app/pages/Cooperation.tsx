...
export default function Cooperation({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={embedded ? "cooperation-embedded" : "page"}>
      <div className="page-header">
        {!embedded && <h2><Handshake size={24} style={{ marginRight: 8, verticalAlign: 'middle' }} /> 업무협조요청</h2>}
